...
public class Add_MainActivity extends AppCompatActivity {
    ...
    EditText  edt_motamonan, edt_giamonan, edt_tenmonan;
        ...
        FirebaseDatabase.getInstance().getReference().child("OrderFood").push()
                .setValue(map).addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        Toast.makeText(Add_MainActivity.this,"Thêm Nước Uống thành công!",Toast.LENGTH_SHORT).show();

                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(Add_MainActivity.this,"Thêm Nước Uống thất bại!",Toast.LENGTH_SHORT).show();
